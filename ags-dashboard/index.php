    ...
    <div class="pcoded-content">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h5> Yesterday - Sales <small style="color: #343a40;font-weight: bold;text-shadow: 0px 0px 1px #0000003b;background-color: #ff0;font-size: 10px;">(Excl. Return)</small></h5>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h5> Yesterday - Purchase Receivable <small style="color: #343a40;font-weight: bold;text-shadow: 0px 0px 1px #0000003b;background-color: #ff0;font-size: 10px;">(Food Details)</small></h5>
                    </div>
                    <div class="card-body px-0 py-0">
        ...
        <div class="row homeIndexedTables">
            <div class="col-sm-12">
                <div class="card overflow-hidden mb-3">
                    <div class="card-header">
                        <h5><i class="fas fa-chart-line"></i> Sales <small style="color: #343a40;font-weight: bold;text-shadow: 0px 0px 1px #0000003b;background-color: #ff0;font-size: 10px;">(Excl. Return)</small></h5>                        
                        <button type="button" title="Reload Data" onclick="salesExclRetn_fn();" class="btn btn-sm btn-icon btn-outline-primary has-ripple" style="float:right;width:22px;height:22px;font-size: 10px;"><i class="fa fa-sync"></i><span class="ripple ripple-animate" style="height: 30px; width: 30px; animation-duration: 0.7s; animation-timing-function: linear; background: rgb(255, 255, 255); opacity: 0.4; top: -4.85938px; left: -4.03906px;"></span></button>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12">
                <div class="card overflow-hidden mb-3">
                    <div class="card-header">
                        ...
                        <button type="button" title="Reload Data" onclick="purchaseReceive_fn();" class="btn btn-sm btn-icon btn-outline-primary has-ripple" style="float:right;width:22px;height:22px;font-size: 10px;"><i class="fa fa-sync"></i><span class="ripple ripple-animate" style="height: 30px; width: 30px; animation-duration: 0.7s; animation-timing-function: linear; background: rgb(255, 255, 255); opacity: 0.4; top: -4.85938px; left: -4.03906px;"></span></button>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12">
                <div class="card overflow-hidden mb-3">
                    <div class="card-header">
                        ...
                        <button type="button" title="Reload Data" onclick="salesReturn_fn();" class="btn btn-sm btn-icon btn-outline-primary has-ripple" style="float:right;width:22px;height:22px;font-size: 10px;"><i class="fa fa-sync"></i><span class="ripple ripple-animate" style="height: 30px; width: 30px; animation-duration: 0.7s; animation-timing-function: linear; background: rgb(255, 255, 255); opacity: 0.4; top: -4.85938px; left: -4.03906px;"></span></button>
                    </div>
                    <div class="card-body">
...
function salesExclRetn_fn() {
	 $("#agsSalesexclReturn_tbl").DataTable().ajax.reload();
	 $.toast({
	    heading: 'Reloaded Live Data',
	    text: 'All AGS loccation sales exclusive return data refreshed.',
	    position: 'top-center',
	    stack: false,
	    icon: 'info'
	});
}
function purchaseReceive_fn() {
 $("#agsPurchaserec_tbl").DataTable().ajax.reload();
	 $.toast({
	    heading: 'Reloaded Food Data',
	    text: 'Purchase receivable food data refreshed for all AGS locations.',
	    position: 'top-center',
	    stack: false,
	    icon: 'info'
	});
...
function salesReturn_fn() {
 $("#agsSalesReturn_tbl").DataTable().ajax.reload();
	 $.toast({
	    heading: 'Reloaded Sales Return Data',
	    text: 'Sales return data refreshed for failure and success transcations.',
	    position: 'top-center',
	    stack: false,
	    icon: 'info'
	});
