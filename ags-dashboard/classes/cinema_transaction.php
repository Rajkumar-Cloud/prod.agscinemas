...
$transHistoryData1 = [];
$array = [];
$transData = $link->query("SELECT id AS trans_local_id, txnid, status AS trans_status, userid, date AS trans_date FROM `transactionhistory` WHERE date NOT LIKE '%0000-00-00 00:00:00%' AND date > '2021-10-10' ORDER BY id DESC");
